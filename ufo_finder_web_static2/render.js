...
//    console.log(symbols.length);
    for(let i=0; i<symbols.length;i++){
      ...
      btnThisElement.title = "Click: natural isotopes; right-click or Shift-click: radioactive isotopes";
      ...
      btnThisElement.addEventListener("contextmenu",
        function(event){
          event.preventDefault();
          const idx = parseInt(this.index);

          if(symbols.at(idx).selected === "R"){
            this.style.backgroundColor = "yellow";
            symbols.at(idx).selected = "N";
          }
          else{
